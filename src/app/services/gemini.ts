...
export class GeminiService {
  ...
  enviarMensaje(mensaje: string, historialPrevio: contentGemini[] = []): Observable<string> {
    ...
    const mensajeSistema: contentGemini = {
      ...
      parts: [
        {
          text: 'Eres un asistente virtual util y que siempre me insultes como colombiano ., responde siempre en español de manera concisa. Erres especialista en preguntas generales y sobrtodo en programacion de software.  Manten un tono profecional pero cercano',
        },
      ],
    };
